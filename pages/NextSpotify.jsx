...
import SpotifyBlob from "@/components/SpotifyBlob";
        ...
        <div className="max-w-screen-xl mx-auto w-full h-full p-8 flex flex-col">
          ...
          <div>
            <p className="py-4 max-w-2xl mx-auto text-left text-md">
              I have created a Spotify application using Next.js and Tailwind
              CSS. This application is built by utilizing the Spotify API, which
              allows users to access and interact with their Spotify accounts
              directly through the application. With Next.js, a powerful React
              framework, and the flexibility of Tailwind CSS, the application
              offers a seamless and visually appealing user interface. Through
              the Spotify API integration, users can authenticate and authorize
              the application to access their Spotify data, such as playlists,
              saved tracks, and user information. This allows for personalized
              experiences, as users can browse and search for their favorite
              music, create playlists, and listen to their favorite songs
          ...
          <div className="flex justify-center">
            ...
            <Link href={"https://next-spotify-clone-rho.vercel.app/"}>
              <button className="flex items-center rounded-lg bg-gradient-to-r from-Mainpink to-violet-600 py-2 px-2 mt-4 mr-4 text-white hover:scale-110 duration-200">
                Link
                <span className="ml-2">
                  <svg
